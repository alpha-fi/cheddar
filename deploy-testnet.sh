...
#near deploy $CONTRACT_ACC ./res/cheddar_coin.wasm new "{\"owner_id\":\"$OWNER\"}" --accountId $MASTER_ACC

##redeploy only
near deploy $CONTRACT_ACC ./res/cheddar_coin.wasm  --accountId $MASTER_ACC
